 ...
 */
@Entity
@Table(name = "estimations_2half", schema = "public", catalog = "school_project")
public class Estimations2HalfEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        Estimations2HalfEntity that = (Estimations2HalfEntity) o;
