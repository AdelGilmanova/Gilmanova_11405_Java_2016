...
import ru.kpfu.itis.Gilmanova.aspects.TeacherAspect;
...
@WebAppConfiguration
public class TeacherAspectTest {
    @InjectMocks
    private static TeacherAspect teacherAspect;
    @Mock
    ...
    public void checkingShouldBeRight() throws Throwable {
        ...
        Assert.assertEquals(obj, teacherAspect.checking(jp));
    }
}
