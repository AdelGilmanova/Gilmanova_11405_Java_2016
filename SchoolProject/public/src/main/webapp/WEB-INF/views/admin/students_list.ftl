...
<div class="diary-block">
    ...
    <p class="inline"></p><input type="text" id="s" oninput="f()"/>
    <form method="GET" id="formx" action="javascript:void(null);" onsubmit="call()" class="inline right">
        <select name="classId">
        ...
        <button id="searchClass">Поиск</button>
    </form>
<br><br>
    <div id="res">
