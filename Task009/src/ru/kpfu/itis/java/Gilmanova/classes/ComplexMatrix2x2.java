...
public class ComplexMatrix2x2 {
    private ComplexNumber c[][] = new ComplexNumber[2][2];
    ...
    public ComplexMatrix2x2 add(ComplexMatrix2x2 m) {
        return new ComplexMatrix2x2(c[0][0].add(m.getA00()), c[0][1].add(m.getA01()), c[1][0].add(m.getA10()), c[1][1].add(m.getA11()));
    }

    public ComplexMatrix2x2 mult(ComplexMatrix2x2 m) {
        return new ComplexMatrix2x2(c[0][0].mult(m.getA00()).add(c[0][1].mult(m.getA10())), c[0][0].mult(m.getA01()).add(c[0][1].mult(m.getA11())),
                c[1][0].mult(m.getA00()).add(c[1][1].mult(m.getA10())), c[1][0].mult(m.getA01()).add(c[1][1].mult(m.getA11())));
    }
    ...
    public void setA00(ComplexNumber a00) {
        this.c[0][0] = a00;
    }

    public void setA01(ComplexNumber a01) {
        this.c[0][1] = a01;
    }

    public void setA10(ComplexNumber a10) {
        this.c[1][0] = a10;
    }

    public void setA11(ComplexNumber a11) {
        this.c[1][1] = a11;
    }
}
